...
const CatalogProducts = () => {
  ...
  // Use React Query hooks - Каталог = каталожные товары (type: 'catalog')
  const { data: allProducts = [], isLoading: loading, error } = useProducts({ enabled_only: false, type: 'catalog' });
    ...
    return (
      <div className="figma-container bg-white">
        <div className="flex items-center justify-between px-4 mt-5">
          <h1 className="text-2xl font-['Open_Sans'] font-normal">Каталог</h1>
        </div>
