...
const VitrinaProducts = () => {
  ...
  const [activeNav, setActiveNav] = useState('vitrina');
  ...
  // Use React Query hooks - Витрина = готовые букеты (type: 'vitrina')
  const { data: allProducts = [], isLoading: loading, error } = useProducts({ enabled_only: false, type: 'vitrina' });
    ...
    return (
      <div className="figma-container bg-white">
        <div className="flex items-center justify-between px-4 mt-5">
          <h1 className="text-2xl font-['Open_Sans'] font-normal">Витрина</h1>
        </div>
...
export default VitrinaProducts;